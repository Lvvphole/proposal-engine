...
class TestJob01_Persistence:
    ...
    async def test_list_envelopes_multiple(self, db_session):
        from contracts.envelope import Envelope
        from harness.models import list_envelopes, save_envelope
...
class TestJob03_ModelCapabilities:
    ...
    def test_register_model(self):
        from harness.model_capabilities import ModelCapabilities, get_capabilities, register_model
    ...
    def test_assert_capability_missing_raises(self):
        ...
        from harness.model_capabilities import ModelCapabilities, assert_capability, register_model
...
class TestJob06_PromptAssembler:
    ...
    def test_assemble_eval_mode(self):
        ...
        assert (
            "eval" in prompt.lower()
            or "confidence" in prompt.lower()
            or "evaluation" in prompt.lower()
        )
...
class TestJob09_ReviewResumePath:
    ...
    async def test_review_approved(self, app_with_db, tmp_path):
        ...
        env.advance(
            ...
            DomainEvent(kind=EventKind.REVIEW_REQUESTED, agent="test"),
        )
        async with _get_session_factory()() as session:
...
class TestJob13_DocumentPreparer:
    ...
    def test_prepare_document_truncates(self):
        from harness.document_preparer import _reset_cache, prepare_document
    ...
    def test_preflight_check_exceeds_window(self):
        ...
        from harness.document_preparer import preflight_check
        from harness.model_capabilities import ModelCapabilities, register_model
